            ...
            try {
                ...
                if(msg.type.equals("message")){
                    if(msg.recipient.equals(ui.username)){
                        ui.jTextArea1.append("["+msg.sender +" > Me] : " +Security.AESCrypt.decrypt( msg.content) + "\n");
                     // JOptionPane.showConfirmDialog(ui, ("Message  '"+msg.content+"' from "+msg.sender+" ?")) ;
                  try{
                   ui.setState(ui.NORMAL);
                  }catch(Exception ex) {System.out.println(ex.toString());}
//        ui.repaint();
//           ui.setFocusable(true);
//                  
//           ui.setExtendedState(ui.ICONIFIED);
 
                      // JOptionPane.showConfirmDialog(null,  ui.getState()); 
                    }
                    else{
                    	 ui.jTextArea1.append("["+ msg.sender +" > "+ msg.recipient +"] : " +Security.AESCrypt.decrypt(  msg.content) + "\n");
